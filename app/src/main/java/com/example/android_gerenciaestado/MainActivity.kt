            ...
            Android_GerenciaEstadoTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    Column {
                        ...
                        ContadorStateless(contador, onIncrementContador = {viewModel.incrementar()},onDecrementContador = {viewModel.decrementar()} ,modifier = Modifier.padding(innerPadding))
...
@Composable
fun ContadorStateless(contador: Int, onIncrementContador: () -> Unit,onDecrementContador: () -> Unit, modifier: Modifier = Modifier) {
